...
name2path = {
    ...
    'abide_schaefer100': './data/abide_schaefer100.bin',
    'neurocon_schaefer100': './data/neurocon_schaefer100.bin',
    'ppmi_schaefer100': './data/ppmi_schaefer100.bin',
    'taowu_schaefer100': './data/taowu_schaefer100.bin', 
}
